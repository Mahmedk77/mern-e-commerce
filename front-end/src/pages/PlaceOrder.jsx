  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
        ...
        <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
            ...
            <input onChange={onChangeHandler} name='email' value={formData.email} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Email address' required/>
        ...
        <div className='mt-8'>
            ...
            <div className='mt-12'>
                <Title text1={"PAYMENT"} text2={"MEHTOD"} /> 
                {/* ---------------PAYMENT METHOD SELECTION--------------------- */}
                <div className='flex gap-3 flex-col lg:flex-row'>
                    <div onClick={() => setMethod("stripe")} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                        <p  className={`min-w-3.5 h-3.5 border rounded-full ${method == "stripe" ? "bg-green-500" : ""}`}></p>
                        <img   className='h-5 mx-4' src={assets.stripe_logo} alt="stripe payment logo at place order" />
                    </div>
                    <div onClick={() => setMethod("razor")} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                        ...
                        <img className='h-5 mx-4' src={assets.razorpay_logo} alt="stripe payment logo at place order" />
                    </div>
